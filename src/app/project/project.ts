export class Project {
   ...
   static projects: Project[] = [
      {
         title: 'Dino Store',
         source: 'assets/project-imgs/dino-store.png',
      ...
      {
         title: 'Book Search',
         source: 'assets/project-imgs/book-Search.png',
      ...
      {
         title: 'Job Finder',
         source: 'assets/project-imgs/job-finder.png',
      ...
      {
         title: 'The Tech Blog',
         source: 'assets/project-imgs/tech-blog.png',
      ...
      },
      {
         ...
         source: 'assets/project-imgs/budget-tracker.png',
      ...
      {
         title: 'Note Taker',
         source: 'assets/project-imgs/note-taker.png',
      ...
      {
         title: 'Game Finder',
         source: 'assets/project-imgs/game-finder.png',
      ...
      },
      {
         ...
         source: 'assets/project-imgs/weather-dashboard.png',
      ...
      {
         title: 'Day Planner',
         source: 'assets/project-imgs/day-planner.png',
      ...
      {
         title: 'Coding Quiz',
         source: 'assets/project-imgs/coding-quiz.png',
      ...
      },
      {
         ...
         source: 'assets/project-imgs/password-generator.png',
